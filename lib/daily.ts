...
export function itemsForDay(date: Date, incomes: IncomeRule[], bills: BillRule[], statements: CardStatement[]) {
  ...
  const expenseTotal = bls.reduce((s, r) => s + r.amount, 0) + sts.reduce((s, r) => s + r.amount_total, 0)
